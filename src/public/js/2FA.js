    ...
    .on('click', function () {
      $.ajax({
        ...
        success: function (data) {
          const btnDisableHTML =
            '<button id="btn-disable-2fa" class="btn btn-default custom-background-btn-reset">Tắt xác thực 2 lớp</button>'
    ...
    .on('click', function () {
      $.ajax({
        ...
        success: function (data) {
          if (data.success) {
            const btnEnableHTML =
              '<button id="btn-enable-2fa" class="btn btn-primary custom-background-btn-primary">Bật xác thực 2 lớp</button>'
