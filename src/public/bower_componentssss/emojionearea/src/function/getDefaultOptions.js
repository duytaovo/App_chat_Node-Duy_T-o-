    ...
    if (supportMode > 4) {
      defaultOptions.filters = {
        tones: {
          title: 'Diversity',
          emoji:
            'open_hands raised_hands clap pray thumbsup thumbsdown punch fist left_facing_fist right_facing_fist ' +
        ...
        symbols: {
          ...
          title: 'Symbols',
          emoji:
            'heart yellow_heart green_heart blue_heart purple_heart black_heart broken_heart heart_exclamation two_hearts ' +
