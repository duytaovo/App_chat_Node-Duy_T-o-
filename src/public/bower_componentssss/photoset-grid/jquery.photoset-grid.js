  ...
  Plugin.prototype = {
    ...
    _setupRows: function (elem, options) {
      ...
      $.each(this.rows, function (i, val) {
        ...
        $images
          ...
          .wrapAll('<div class="photoset-row cols-' + val + '"></div>')
    ...
    _setupColumns: function (elem, options) {
      ...
      var setupStyles = function (waitForImagesLoaded) {
        ...
        if (options.highresLinks) {
          $images.each(function () {
            ...
            $(this).wrapAll(
              '<a href="' + highres + '" class="photoset-cell highres-link" />'
            )
          })
            ...
            $rows.each(function () {
              ...
              $(this)
                ...
                .each(function () {
                  ...
                  if (
                    parseInt($img.css('width'), 10) > options.lowresWidth &&
              ...
              var rowHeight =
                ($shortestImg.attr('height') *
                  parseInt($shortestImg.css('width'), 10)) /
                $shortestImg.attr('width')
      ...
      $(elem)
        ...
        .each(function () {
          hasDimensions =
            hasDimensions & (!!$(this).attr('height') & !!$(this).attr('width'))
        })
