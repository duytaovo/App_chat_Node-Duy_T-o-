...
!(function (a, b, c, d) {
  ...
  ;(e.prototype = {
    ...
    _setupRows: function (b, c) {
      ...
      a.each(this.rows, function (a, b) {
        ...
        h
          .slice(c, d)
          .wrapAll('<div class="photoset-row cols-' + b + '"></div>'),
          (i = d)
      }),
        a(b)
          .find('.photoset-row:not(:last-child)')
          .css({ 'margin-bottom': c.gutter })
    },
        ...
        f = function (e) {
            ...
            b !== a(c).attr('data-width') &&
              (g.each(function () {
                ...
                a(this)
                  ...
                  .each(function () {
                    var c = a(this)
                    c.attr('height') < b.attr('height') && (b = a(this)),
                      parseInt(c.css('width'), 10) > d.lowresWidth &&
                        c.attr('data-highres') &&
                        c.attr('src', c.attr('data-highres'))
                  })
                var c =
                    (b.attr('height') * parseInt(b.css('width'), 10)) /
                    b.attr('width'),
                  e = Math.floor(0.025 * c)
                a(this).height(c - e),
                  a(this)
                    .find('img')
                    .each(function () {
          ...
          d.highresLinks
            ? (h.each(function () {
                var b
                ;(b = a(this).attr(
                  a(this).attr('data-highres') ? 'data-highres' : 'src'
                )),
                  a(this).wrapAll(
                    '<a href="' + b + '" class="photoset-cell highres-link" />'
                  )
              }),
              d.rel && h.parent().attr('rel', d.rel))
            : h.each(function () {
          ...
          a(c).css({ width: d.width }),
            g.css({ clear: 'left', display: 'block', overflow: 'hidden' }),
            i.css({
              float: 'left',
              display: 'block',
              'line-height': '0',
          ...
          a(c)
            ...
            .css({ 'padding-right': o / 2 + 'px' }),
            a(c)
              .find('.photoset-cell:not(:first-child)')
              .css({ 'padding-left': o / 2 + 'px' }),
            f(),
  ...
  a.fn.imagesLoaded = function (b) {
    function c() {
      var c = a(m),
        d = a(n)
      i && (n.length ? i.reject(k, c, d) : i.resolve(k)),
        a.isFunction(b) && b.call(g, k, c, d)
    }
    function e(a) {
    ...
    function f(b, d) {
      b.src !== h &&
        ...
        j && i.notifyWith(a(b), [d, k, a(m), a(n)]),
        k.length === l.length && (setTimeout(c), k.unbind('.imagesLoaded', e)))
    }
    var g = this,
      ...
      k.length
        ? k
            ...
            .each(function (b, c) {
              ...
              return g && g.src === e
                ? void f(c, g.isBroken)
                : c.complete && c.naturalWidth !== d
                ? void f(c, 0 === c.naturalWidth || 0 === c.naturalHeight)
                : void (
                    (c.readyState || c.complete) &&
                    ((c.src = h), (c.src = e))
                  )
            })
        : c(),
      ...
      ;(j = !0),
        k ||
          (setInterval(function () {
            n++,
              ((n > i.threshold && j) || c) &&
                ((b.type = 'throttledresize'),
                l.dispatch.apply(d, e),
                (j = !1),
                (n = 0)),
              n > 9 && (a(m).stop(), (k = !1), (n = 0))
          }, 30),
          (k = !0))
    },
    threshold: 0
