                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      ...
                      case 3:
                        return (
                          (c = t.sent()),
                          r.emitError(l.PeerErrorType.WebRTC, c),
                          a.default.log('Failed to handleCandidate, ', c),
                          [3, 4]
                        )
                      case 4:
                        return [2]
    ...
    dbHP: [
      function (require, module, exports) {
        ...
        var r = require('./util'),
          ...
          c = (function (n) {
            function l(e, t, o) {
              var i = n.call(this, e, t, o) || this
              return (
                (i._localStream = i.options._stream),
                (i.connectionId =
                  i.options.connectionId || l.ID_PREFIX + r.util.randomToken()),
            ...
            return (
              ...
              (l.prototype.addStream = function (e) {
                i.default.log('Receiving stream', e),
                  ...
                  n.prototype.emit.call(this, s.ConnectionEventType.Stream, e)
              }),
              ...
              (u.prototype._handleDataMessage = function (e) {
                ...
                if (
                  ...
                  if (o === Blob)
                    return void r.util.blobToArrayBuffer(i, function (e) {
                      ;(i = r.util.unpack(e)),
                        t.emit(s.ConnectionEventType.Data, i)
                    })
                ...
                if (i.__peerData) {
                  ...
                  return (
                    ...
                    l.count++,
                    l.total === l.count &&
                      (delete this._chunkedData[u],
                      (i = new Blob(l.data)),
                      this._handleDataMessage({ data: i })),
                    void (this._chunkedData[u] = l)
                  )
                }
