...
const initRoutes = app => {
  ...
  router.get(
    '/contact/find-name-conversations',
    auth.checkLoggedIn,
    contactValid.findNameConversations,
    contact.findNameConversations
  )
  router.get(
  ...
  router.get(
    '/contact/talk-contact/:contactId',
    auth.checkLoggedIn,
    contact.talkContact
  )
  router.get(
    '/contact/talk-group/:groupId',
    auth.checkLoggedIn,
    contact.talkGroup
  )
  ...
  router.put(
    ...
    auth.checkLoggedIn,
    groupChat.leaveGroupChat
  )
  router.get(
    '/group-chat/find-user-to-add-group-chat',
    auth.checkLoggedIn,
    groupChatValid.findUsersToAddGroupChat,
    groupChat.findUsersToAddGroupChat
  )
  router.put(
    '/group-chat/add-member-to-group-chat',
    auth.checkLoggedIn,
    groupChat.addMemberToGroupChat
  )
  ...
  router.get(
    '/tutorial-setting-facebook',
    auth.checkLoggedOut,
    auth.tutorialSettingFacebook
  )
