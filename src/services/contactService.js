...
const findNameConversations = (currentUserId, keyword) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      let groups = await ChatGroupModel.findAllGroupConversations(
        currentUserId,
        keyword
      )
...
const removeContact = (currentUserId, contactId) => {
  return new Promise(async (resolve, reject) => {
    const removeContact = await ContactModel.removeContact(
      currentUserId,
      contactId
    )
...
const approveRequestContactReceived = (currentUserId, contactId) => {
  return new Promise(async (resolve, reject) => {
    try {
      let messages = await MessageModel.model.getMessagesInPersonal(
        currentUserId,
        contactId,
...
const readMoreContacts = (currentUserId, skipNumberContacts) => {
  return new Promise(async (resolve, reject) => {
    try {
      const newContacts = await ContactModel.readMoreContacts(
        currentUserId,
        skipNumberContacts,
        LIMIT_NUMBER_TAKEN
      )
...
const readMoreContactsSent = (currentUserId, skipNumberContacts) => {
  return new Promise(async (resolve, reject) => {
    try {
      const newContacts = await ContactModel.readMoreContactsSent(
        currentUserId,
        skipNumberContacts,
        LIMIT_NUMBER_TAKEN
      )
...
const readMoreContactsReceived = (currentUserId, skipNumberContacts) => {
  return new Promise(async (resolve, reject) => {
    try {
      const newContacts = await ContactModel.readMoreContactsReceived(
        currentUserId,
        skipNumberContacts,
        LIMIT_NUMBER_TAKEN
      )
...
const talkGroup = groupId => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      let messages = await MessageModel.model.getMessagesInGroup(
