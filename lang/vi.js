export const transValidation = {
  ...
  keyword_find_user:
    'Nội dung tìm kiếm gồm 1-16 kí tự, không được chứa kí tự đặc biệt, chỉ cho phép chữ cái, số và khoảng trống',
  keyword_find_user_conversations:
    'Nội dung tìm kiếm không hợp lệ, giới hạn từ 1 - 16 kí tự và không chứa kí tự đặc biệt.',
  message_text_emoji_incorrect:
    'Tin nhắn không hợp lệ. Đảm bảo tối thiểu 1 ký tự, tối đa 400 kí tự',
  add_new_group_users_incorrect:
    'Vui lòng chọn bạn bè để thêm vào nhóm, tối thiểu 2 người',
  add_new_group_name_incorrect:
    'Vui lòng nhập tên cuộc trò chuyện, giới hạn từ 5 - 30 kí tự và không chứa kí tự đặc biệt.',
...
export const transError = {
  ...
  server_error:
    'Lỗi ở máy chủ, vui lòng liên hệ đến bộ phận hỗ trợ để thông báo lỗi này, xin cảm ơn!',
  ...
  facebook_not_add_email:
    "Vui lòng thêm email vào tài khoản facebook để sử dụng được chức năng này, click <a href='/tutorial-setting-facebook' target='_blank'>vào đây</a> để được hướng dẫn nếu bạn chưa biết cách thêm email."
}
